// src/modules/stats/ContributorCard.tsx
...
export default function ContributorCard({ contributor, rank }: P) {
  ...
  return (
    <div className="rounded-xl border bg-card p-4 space-y-3 transition-colors hover:bg-muted/30">
      <div className="flex items-center gap-3">
        <span className="text-lg font-bold w-6 text-center shrink-0 tabular-nums">
          {rank}
        </span>
